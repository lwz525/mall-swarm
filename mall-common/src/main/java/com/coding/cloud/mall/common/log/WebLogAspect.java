...
import com.coding.cloud.mall.common.domain.WebLog;
...
public class WebLogAspect {
    @Pointcut("execution(public * com.coding.cloud.mall.controller.*.*(..)) || execution(public * com.coding.cloud.mall.*.controller.*.*(..))")
    public void webLog() {
    }
    @Before("webLog()")
